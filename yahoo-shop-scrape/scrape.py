...
try:
  ...
  ...
URL = 'https://(shopping|store|store\.shopping).yahoo.co.jp'
def html(url): 
  try:
...
def main():
  seed = 'https://store.shopping.yahoo.co.jp/nanaple/010-01733-13.html?sc_i=shp_pc_search_itemlist_shsr_title'
  urls = html(seed) 
  print(urls) 
  try:
